...
- NoSQL은 CAP(Consistency, Availability, Partition tolerance) 이론을 따른다. 또한 ACID 속성보다는 BASE(Basically Available, Soft state, Eventually consistent) 모델을 채택하여 즉시 일관성보다는 최종 일관성을 보장한다.
